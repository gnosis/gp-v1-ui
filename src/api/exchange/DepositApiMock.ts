...
export class DepositApiMock implements DepositApi {
  ...
  public async deposit(
    ...
    await this._erc20Api.transferFrom(tokenAddress, userAddress, this.getContractAddress(), amount)
  ...
  public async withdraw(
    ...
    await this._erc20Api.transfer(tokenAddress, userAddress, amount)
