...
export const ORDER_BOOK_ONE_SIDED_MARKET_ZOOM_PERCENTAGE = 0.05 // %
export const ORDER_BOOK_ZOOM_MULTIPLIER = 3 // Initial zoom length = spread + 2 * spread * ORDER_BOOK_ZOOM_MULTIPLIER
