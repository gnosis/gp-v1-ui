...
export const WETH_NETWORK_MAP = new Map([
  [Network.Mainnet, WETH_ADDRESS_MAINNET],
  [Network.Rinkeby, WETH_ADDRESS_RINKEBY],
  [Network.xDAI, WETH_ADDRESS_XDAI],
])
export const TOKEN_FILTER_IGNORE_LIST = new Set([
