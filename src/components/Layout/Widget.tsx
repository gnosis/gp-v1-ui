...
const Wrapper = styled(PageWrapper)`
  ...
  min-width: 0;
  background: #FFFFFF;
  box-shadow: rgba(0, 0, 0, 0.02) 0 0.276726rem 0.221381rem 0, rgba(0, 0, 0, 0.027) 0 .666501rem .532008rem 0, rgba(0, 0, 0, 0.035) 0 1.25216rem 1.0172rem 0, rgba(0, 0, 0, 0.043) 0 2.23363rem 1.7869rem 0, rgba(0, 0, 0, 0.05) 0 4.17776rem 3.34221rem 0, rgba(0, 0, 0, 0.07) 0 10rem 8rem 0;
  border-radius: .6rem;
  width: 100%;
  display: flex;
