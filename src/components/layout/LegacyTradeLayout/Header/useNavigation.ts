...
import { HeaderProps } from 'components/layout/LegacyTradeLayout/Header'
import { HeaderNavLinksInterface } from 'components/layout/LegacyTradeLayout/Header/Navigation'
